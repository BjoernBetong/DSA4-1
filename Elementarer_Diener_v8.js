...
//Dialoge
	...
	inputDialog += divFlexStart + `
        ...
        `+ divFlexEnd + hr;
	inputDialog += "<h3><b>" + "Die Entstehung von Mindergeistern" + "</b><br>" + "</h3>";
	inputDialog += divFlexStart + `
...
//Probenwurf
    ...
    async function htmlCallback(html){
		...
		//Roll the dice
        let spellRoll = new Roll("5d20").roll({async: true});
        spellRoll.then(roll =>{
			...
			ProbMinorGhost = w5 + Math.round(AsPcosts/6) + MinorGhostsMod + NaturalForceMod
				failMinorGhost = "Kein Mindergeist erscheint";
				winMinorGhost = "Ein Elementarer Mindergeist " + Elementargeist + " erscheint";
				winMinorGhost18 = "Ein Mindergeist, bestehend aus " + PrimeElement + " und " + SecElement + " erscheint";
			
			if(ProbMinorGhost < 15){
				failOut2 = failMinorGhost;
			}if(ProbMinorGhost > 15, ProbMinorGhost < 18){
				failOut2 = winMinorGhost;
			}else{
				failOut2 = winMinorGhost18;
			}


			//Chat Output
            flavor = "<b> Beschwörung des Elementars </b><br>";
			flavor += "MU: " + w1 + " / " + "<b>" + courage + "</b>";
			flavor += "<br>KL: " + w2 + " / " + "<b>" + cleverness + "</b>";
			flavor += "<br>CH: " + w3 + " / " + "<b>" + charisma + "</b>";
			...
			flavor += "<b> Entstehung von Mindergeistern: </b>" + ProbMinorGhost;
			flavor += "<br>" + failOut2 + "<br>";
