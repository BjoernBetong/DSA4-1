...
//###############################################################################################################################################################################################################################################
	...
	//Talente des Helden
		...
		const RitualkenntnisGildenmagie = token.actor.items.find(item => item.name === "Ritualkenntnis: Gildenmagie");									
		...
		const RitualkenntnisRunenzauberei = token.actor.items.find(item => item.name === "Ritualkenntnis: Runenzauberei");									
		...
		const RitualkenntnisScharlatan = token.actor.items.find(item => item.name === "Ritualkenntnis: Scharlatan");									
